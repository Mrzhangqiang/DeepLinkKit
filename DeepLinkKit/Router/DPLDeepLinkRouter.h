 ...
 */
- (void)registerRoute:(NSString *)route routeHandlerBlock:(DPLRouteHandlerBlock)routeHandlerBlock;
...
NS_SWIFT_UNAVAILABLE("Available in Swift as: registerRoute(route: String, routeHandlerBlock: (DPLDeepLink) -> ())");
